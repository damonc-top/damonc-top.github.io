...
! function(e, t) {
	...
	return function(e) {
		...
		function(e, t, n) {
			"use strict";
			t.__esModule = !0;
			t.DEFAULT_EMOJI_CDN = "//cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/", t.DB_NAME = "Comment", t.CONFIG = {
				lang: "zh-CN",
				langMode: null,
				appId: "",
				appKey: "",
...
*/
		...
		function(e, t, n) {
			...
			i.prototype.Q = function(e) {
				...
				for (var y in m) m.hasOwnProperty(y) && function() {
					...
					v[t] = n, n.on("input change blur propertychange", function(r) {
						e.cfg.enableQQ && "blur" === r.type && "nick" === t && (n.val() && !isNaN(n.val()) ? (0, b.fetchQQFn)(n.val(), function(e) {
								var t = e.data.name || n.val(),
									r = e.data.qq + "@qq.com";
								(0, A.
									default)(".vnick").val(t), (0, A.
										default)(".vmail").val(r), S.nick = t, S.mail = r, S.QQAvatar = e.data.avatar
							}) : A.
					...
					return n.length > 0 ? n[0] : ""
						...
						var i = (0, A.
							...
							o = (0, C.
								default)(t.get("ua")),
							a = "";
						o && !/ja/.test(e.cfg.lang) && (o = A.
							default.detect(o), a = o.version ? o.os ? '<span class="vsys">' + o.browser + " " + o.version + '</span> <span class="vsys">' + o.os + " " + o.osVersion + "</span>" : "" : '<span class="vsys">' + o.browser + "</span>"), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
						...
						default.escape((0, C.
							...
							default)('<img class="vimg" src="' + j(t.get("QQAvatar")) + '" referrerPolicy="no-referrer"/>') : '<img class="vimg" src="' + ($.cdn + (0, u.
							default)(t.get("mail")) + $.params) + '">', p = f + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, g.
				...
				! function(t) {
					...
					S.QQAvatar = e.cfg.enableQQ && !! i && i.data.avatar || ""
				}(), e.reset = function() {
                ...
                var commentRG = ["黄","毒","赌","http","https","www","操","草","cao","b","B","日","滚","com"];
				var M = e.$el.find(".vsubmit"),
					L = function(t) {
						...
						B = {}, S.comment = (0, C.
							default)(O), S.nick = S.nick || "\u533f\u540d\u8005";
						var i = A.
						default.store.get("vlx");

                        S.comment = S.comment.replace(/黄/g, "*");
                        S.comment = S.comment.replace(/赌/g, "*");
                        S.comment = S.comment.replace(/毒/g, "*");
                        S.comment = S.comment.replace(/http/g, "*");
                        S.comment = S.comment.replace(/w/g, "*");
                        S.comment = S.comment.replace(/com/g, "*");
                        S.comment = S.comment.replace(/草/g, "*");
                        S.comment = S.comment.replace(/cao/g, "*");
                        S.comment = S.comment.replace(/操/g, "*");
                        S.comment = S.comment.replace(/b/g, "*");
                        S.comment = S.comment.replace(/B/g, "*");
                        S.comment = S.comment.replace(/日/g, "*");
                        S.comment = S.comment.replace(/fuck/g, "*");
                        S.comment = S.comment.replace(/淫/g, "*");
                        S.comment = S.comment.replace(/妓/g, "*");
                        S.comment = S.comment.replace(/女/g, "*");
                        S.comment = S.comment.replace(/逼/g, "*");
						if (i) {
		...
		function(e, t, n) {
			...
			default = function(e, t) {
				...
				o ? t && t() : i.
				default.sdkLoader("https://damonc-top2.github.io/web-assets/commons/av-min.js", "AV", function(n) {
					var r = "https://",
						i = "",
						a = e.app_id || e.appId,
